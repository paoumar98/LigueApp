...
{ data: 'id', name: 'id' },
{ data: 'home_name', name: 'home.name' },
{ data: 'away_name', name: 'away.name' },
{ data: 'start_time', name: 'start_time' },
{ data: 'ticket', name: 'ticket' },
{ data: 'result_h', name: 'result_h' },
{ data: 'result_a', name: 'result_a' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  $('.datatable-Match').DataTable(dtOverrideGlobals);
